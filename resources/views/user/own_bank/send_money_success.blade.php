      ...
      <div class="row">
        <div class="col-md-9 col-lg-7 col-xl-6 mx-auto">
          ...
          <div class="bg-white text-center shadow-sm rounded p-3 pt-sm-4 pb-sm-5 px-sm-5 mb-4">
            ...
            <p class="text-3 mb-4">You've Succesfully sent <span class="text-4 fw-500">{{ $gnl->cur_sym }}{{ $amount }}</span> to <span class="fw-500">{{ $username }}</span>, See transaction details under <a class="btn-link" href="{{route('user.transections')}}">Transections</a>.</p>
