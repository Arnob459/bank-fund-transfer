    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="exampleValidation" method="post" action="{{ route('admin.banks.update', $bank->id) }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-file input-file-image">
                                            <div class="form-group ">
                                                ...
                                                src="{{ asset('assets/images/banks/'.$bank->image) }}" alt="preview">
                                            </div>
                                            <div class="col-lg-12 ">
                                                <div class="input-file input-file-image">
                            ...
                            <div class="col-md-9">
                                <div class="row " >
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control " placeholder="Routing Number" name="routing_number"
                                               value="{{ $bank->routing_number }}" required/>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" name="minimum_limit" placeholder="0"
                                                       value="{{ formatter_money($bank->minimum_limit)  }}" required/>
                                                       <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="0" name="maximum_limit"
                                                       value="{{ formatter_money($bank->maximum_limit)  }}" required/>
                                                <div class="input-group-append">
                                                    <div class="input-group-text">{{ $gnl->cur }}</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="0"
                                                       name="fixed_charge"
                                                       value="{{ formatter_money($bank->fixed_charge)  }}" required/>
                                                <div class="input-group-append">
                                                    <div class="input-group-text">{{ $gnl->cur }}</div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="0"
                                                       name="percent_charge" value="{{ $bank->percent_charge }}"
                                                       required>
                                                <div class="input-group-prepend">
                                ...
                                <div class="card outline-dark">
                                    ...
                                    <div class="card-body">
                                        <div class="form-row" id="userData">
                                            @foreach(json_decode($bank->user_data) as $data)
