            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="counter_title" class="form-control form-control-lg" id="basicInput" value="{{ $counter->title }}"  required>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="counter_subtitle" class="form-control form-control-lg" id="basicInput" value="{{ $counter->sub_title }}"  required>
                    </div>
                </div>
                <hr>
                        ...
                        <table class="table table-lg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500">{{ $item->number }}</td>
                                    <td>
                                        <a  href="{{ route('admin.counter.edit',$item->id) }}"  class="btn btn-primary rounded-pill"  ><i class ="bi bi-pencil">Edit</i></a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="POST" action="{{ route('admin.counter.destroy', $item->id) }}">
                                                            @csrf
                                                            @method('DELETE')
