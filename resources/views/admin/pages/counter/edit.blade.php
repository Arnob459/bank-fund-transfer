...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            <form id="socialForm" action="{{ route('admin.counter.update',$counter->id) }}" method="post" enctype="multipart/form-data" onsubmit="store(event)">
                @csrf
            <div class="row">
