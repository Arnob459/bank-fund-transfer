            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="work_title" class="form-control form-control-lg" id="basicInput" value="{{ $work->title }}"  required>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="work_subtitle" class="form-control form-control-lg" id="basicInput" value="{{ $work->sub_title }}"  required>
                    </div>
                </div>
                <hr>
