...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            <form id="socialForm" action="{{ route('admin.choose.update',$choose->id) }}" method="post" enctype="multipart/form-data" onsubmit="store(event)">
                @csrf
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="subtitle" class="form-control form-control-lg" id="basicInput" value="{{ $choose->short_text }}" required>
                            </div>
                        </div>
