                        ...
                        <table class="table table-lg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  href="{{ route('admin.choose.edit',$item->id) }}"  class="btn btn-primary rounded-pill"  ><i class ="bi bi-pencil">Edit</i></a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form method="POST" action="{{ route('admin.choose.destroy', $item->id) }}">
                                                            @csrf
                                                            @method('DELETE')
