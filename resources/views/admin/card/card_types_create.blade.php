            ...
            <div class="row">
                ...
                <div class="form-group col-md-4 mb-3">
                    ...
                    <div class="form-group ">
                        <img src="http://placehold.it/48x30" alt="Image Preview" id="image-preview" width="auto" height="auto"
                    ...
                    <p class="text-warning mb-0">Image Will Resize 48X30 px</p>
                ...
                <div class="col-md-8">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="basicInput" class="mb-2">Enter Card Type Name</label>
                                <input type="text" name="name" class="form-control form-control-lg" id="basicInput" placeholder="Enter Name" required>
                            </div>
                        </div>
