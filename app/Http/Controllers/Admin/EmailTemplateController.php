...
class EmailTemplateController extends Controller
{
    ...
    public function emailSetting()
    {
        ...
        $general_setting = Setting::first()->mail_config;
;        return view('admin.email_template.email_setting', compact('page_title', 'general_setting'));
    ...
    public function emailTemplate()
    {
        ...
        $general_setting = Setting::first(['efrom', 'etemp']);
    ...
    public function emailTemplateUpdate(Request $request)
    {
        ...
        return back()->with('success', 'Global Email Template has been updated.');
    }
    ...
    public function sendTestMail(Request $request)
    {
        ...
        try {
            ...
            return back()->withErrors( strtoupper($config->name) . ' Mail configuration is invalid.');
        }
